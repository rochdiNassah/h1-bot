...
<div class="mx-auto lg:max-w-7xl my-20">
    <div class="space-y-4 bg-gray-600 p-4 rounded-lg border border-gray-400 text-gray-400">
        <form action="string" method="post" class="space-y-2 bg-gray-400 rounded-lg p-4">
            <input autocomplete="false" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline" name="target" type="text" placeholder="String">
            ...
            ">
                <option selected>Choose an operation to perform against the given string</option>
